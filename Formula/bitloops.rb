class Bitloops < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/bitloops/bitloops/releases/download/v0.0.9/bitloops-aarch64-apple-darwin.tar.gz"
      sha256 "33bfc5b6856adc7d370d84d859f47023ca9deb63dd8cc5070af10a8ea3b5f136"
    end
    on_intel do
      url "https://github.com/bitloops/bitloops/releases/download/v0.0.9/bitloops-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/bitloops/bitloops/releases/download/v0.0.9/bitloops-aarch64-unknown-linux-musl.tar.gz"
      sha256 "095ee6571852c90d1ed769b9ad6950bc8cc9e875d0399f46110254fc16ce974b"
    end
    on_intel do
      url "https://github.com/bitloops/bitloops/releases/download/v0.0.9/bitloops-x86_64-unknown-linux-musl.tar.gz"
